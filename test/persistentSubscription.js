...
describe('Persistent Subscription', function() {
    var testStreams = [];
    ...
    context('setting up basic subscription', function () {
        it('should succeed', function (done) {
            dbconn.open(done, function (connection) {
                ...
                var settings = new EventStoreClient.PersistentSubscription.Settings();
                
                testData.writeEvents(
                    connection, credentials, streamName, 10,
                    testData.fooEvent,
                    function () {
                        connection.persistentSubscription(
                            'test', streamName, credentials,
                            function (event) {
